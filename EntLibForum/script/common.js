...
//	var count_pic = 0;
//	for (var i_pic = 0; i_pic < form.elements.length; i_pic++) {
//	    var e_pic = form.elements[i_pic];
//	    if (e_pic.name && e_pic.name != checkall && (!prefix || (prefix && e_pic.name.match(prefix)) && !e_pic.getAttribute("topictype"))) {
//	        e_pic.checked = form.elements[checkall].checked;
//	        if (e_pic.checked) {
//			    count_pic++;
//			}
//		}
