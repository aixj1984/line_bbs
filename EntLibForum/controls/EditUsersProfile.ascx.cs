		...
		protected void UpdateProfile_Click( object sender, System.EventArgs e )
		{
			...
			else
			{
				if ( OldPassword.Text.Length > 0 )
				{
                    ...
                    /// password ≤ªº”√‹
                    /// 2008. 5. 7
                    string oldpw = OldPassword.Text; // FormsAuthentication.HashPasswordForStoringInConfigFile(OldPassword.Text, "md5");
                    string newpw = NewPassword1.Text; // FormsAuthentication.HashPasswordForStoringInConfigFile(NewPassword1.Text, "md5");
                    ///////////////////////////////////////////
			...
			DB.user_save( CurrentUserID, ForumPage.PageBoardID, null, null, email, null, Location.Text, HomePage.Text, TimeZones.SelectedValue, null, Language.SelectedValue, Theme.SelectedValue, null,
					MSN.Text, string.Empty, string.Empty, string.Empty, Realname.Text, Occupation.Text, Interests.Text, Gender.SelectedIndex, Weblog.Text, PMNotificationEnabled.Checked );
