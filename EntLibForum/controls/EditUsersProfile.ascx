...
<table width="100%" class="content" cellspacing="1" cellpadding="4">
    ...
    <tr>
        ...
        <td class="post">
            <asp:TextBox ID="Location" runat="server" CssClass="edit" Width="280px" /></td>
    </tr>
    <tr>
        <td colspan="2" class="header2">
            <b>
    ...
    <tr>
        ...
        <td class="post">
            <asp:TextBox runat="server" ID="HomePage" CssClass="edit" Width="280px" /></td>
    </tr>
    <tr>
        <td class="postheader">
        ...
        <td class="post">
            <asp:TextBox runat="server" ID="Weblog" CssClass="edit" Width="280px" /></td>
    </tr>
    <tr>
        <td colspan="2" class="header2">
            <b>
    ...
    <tr>
        ...
        <td class="post">
            <asp:TextBox runat="server" ID="MSN" CssClass="edit" Width="280px" /></td>
    </tr>
    <tr>
        <td colspan="2" class="header2">
            <b>
    ...
    <asp:PlaceHolder runat="server" ID="LoginInfo" Visible="false">
        ...
        <tr>
            ...
            <td class="post">
                <asp:TextBox ID="Email" CssClass="edit" runat="server" OnTextChanged="Email_TextChanged" Width="280px"/></td>
        </tr>
    </asp:PlaceHolder>
    <tr>
