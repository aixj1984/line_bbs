...
<table width="100%" style="text-align: center; background-color:Gray;" cellspacing="0"
    ...
    <tr>
        <td style="background-image: url(/images/background/navbar_bg.gif); background-repeat: repeat-x;" class="textdesc">
            <a href="http://www.hubeici.com/about_us/" target="_blank">关于我们</a> | <a href="mailto:hubeici@163.com?subject=Contact Us&body=Contact Us"
                target="_blank">联系我们</a> | <a href="http://weibo.com/hbci" target="_blank">新浪微博</a>
        </td>
    </tr>
    <tr style="background: url('images/firstpage/bottom_line.gif'); background-repeat:repeat;width: 100%; ">
        <td>
            <div class="foot2_a2">
                <div id="center">
                    主管：中共湖北省委宣传部&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;主办：中共湖北省委宣传部</div>
                <div id="center">
                    承办：湖北日报传媒集团&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;湖北省文化产业发展信息中心&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;湖北文谷文化产业发展有限公司</div>
                <div id="center">
