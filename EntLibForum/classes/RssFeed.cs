	...
	public class RssFeed
	{
		...
		public XmlTextWriter WriteRSSPrologue(XmlTextWriter writer, pages.ForumPage page)
		{
			...
			*/
			...
			writer.WriteRaw("\t\t<description>" + string.Format("{0}", System.Configuration.ConfigurationManager.AppSettings["RSSDesc"]) + "</description>" + en);
			writer.WriteRaw("\t\t<copyright>" + string.Format("{0}", System.Configuration.ConfigurationManager.AppSettings["RSSCopyright"]) + "</copyright>" + en);
