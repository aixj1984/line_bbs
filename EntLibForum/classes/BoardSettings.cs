...
namespace yaf
{
	public class BoardSettings
	{
		...
		{
			get { return m_regBoard.GetValueInt( "ShowTopicsDefault", 0 ); }
        ...
        public string ForumAd
        {
            get { return m_reg.GetValueString("ForumAd", null); }
            set { m_reg.SetValueString("ForumAd", value); }
        }

        public string FirstPostAd
        {
            get {return m_reg.GetValueString("FirstPostAd", null); }
            set { m_reg.SetValueString("FirstPostAd", value); }
        }
	}
