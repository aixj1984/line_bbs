...
namespace yaf.pages
{
	...
	public partial class posts : ForumPage
	{
		...
		protected void Page_Load( object sender, System.EventArgs e )
		{
            ...
            /// 增加回车自动触发按钮的Click 事件
            /// 2008-5-9
            snvTxt1.Attributes.Add("onkeydown", "if(event.keyCode==13){document.all." + QuickReply.ClientID + ".focus();event.keyCode=13;return true;}");
            ///////////////////////////////////////////////
		...
		protected void QuickReply_Click( object sender, EventArgs e )
		{
            ...
            if (QuickReplyEditor.Text.Trim().Length < 5 )
			{
		...
		private void BindData()
		{
            ...
            if (((DataView)pds.DataSource).Table.Rows.Count == 0)
            {
                txtEmptyContentDesc.Text = "<div align=center style='font-weight:bold; color: red'>指定的话题未经版主审核, 或您没有访问权限!</div><br/>";
            }
		...
		protected void DeleteTopic_Click( object sender, System.EventArgs e )
		{
			...
			DB.user_removepointsByTopicID( PageTopicID, 20 );
