...
<tr>
	...
	<td class=post><asp:textbox id=EmailAddress runat=server cssclass=edit Width="280px"></asp:textbox></td>
</tr>
<tr>
	<td class=postheader><%= GetText("subject") %></td>
	<td class=post><asp:textbox id=Subject runat=server cssclass=edit Width="280px"></asp:textbox></td>
</tr>
<tr>
	<td class=postheader valign=top><%= GetText("message") %></td>
	<td class=post valign=top><asp:textbox id=Message runat=server cssclass=edit TextMode="MultiLine" Rows="12" Width="80%"></asp:textbox></td>
</tr>
<tr>
