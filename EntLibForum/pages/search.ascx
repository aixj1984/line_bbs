...
<yaf:PageLinks runat="server" id="PageLinks"/>
	<table class="content" cellSpacing="1" cellPadding="0" width="100%">
		...
		<tr>
			<td class="postheader" colspan="2" align="center">
				<asp:textbox id="txtSearchString" runat="server" Width="350px" onkeypress="if((event.charCode ? event.charCode : event.keyCode) == 13) { document.getElementById('forum__ctl0_btnSearch').click(); return false; }"/>
