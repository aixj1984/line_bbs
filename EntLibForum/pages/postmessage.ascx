...
<table class="content" cellspacing="1" cellpadding="4" width="100%" align="center">
	...
	<tr id="SubjectRow" runat="server">
		...
		<td class="post" width="80%"><asp:textbox id="Subject" runat="server" cssclass="edit" Width="500px"/></td>
	</tr>
	...
	<tr>
		<td class="postformheader" width="20%" valign="top"><%= GetText("message") %>
			<br/>（必须大于5个字符）： <br />
			<uc1:smileys runat="server" onclick="insertsmiley" ID="smileys1"/>
		</td>
	...
	<!-- <tr>
	<td class=postformheader>验证码 (不区分大小写):</td>
